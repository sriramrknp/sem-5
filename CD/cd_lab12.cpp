...
// NOTE: the way of running the code:
//   g++ cd_lab12.cpp -o main
//   ./main file12.txt
//   ( ./main() file Name as argument )
...
int main(int argc, char **argv)
{
    ...
    cout << "You have entered the " << argc << " arguments\n";
    cout << "Arguments are: \n";
    ...
    cout << "Read from the file named as file12.txt\n";
